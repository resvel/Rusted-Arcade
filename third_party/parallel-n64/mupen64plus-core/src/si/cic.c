...
static const char* cic_version_name(enum cic_version version)
{
    switch (version)
    {
       case CIC_X101: return "CIC_X101";
       case CIC_X102: return "CIC_X102";
       case CIC_X103: return "CIC_X103";
       case CIC_X105: return "CIC_X105";
       case CIC_X106: return "CIC_X106";
       case CIC_5167: return "CIC_5167";
       case CIC_8303: return "CIC_8303";
       case CIC_USDD: return "CIC_USDD";
       case CIC_DVDD: return "CIC_DVDD";
...
void init_cic_using_ipl3(struct cic* cic, const void* ipl3)
{
    ...
    if (getenv("LIBRETRO_TRACE_BOOT"))
    {
       DebugMessage(M64MSG_INFO,
             "CIC detect crc=%llx version=%s seed=%#x",
             (unsigned long long) crc,
             cic_version_name(cic->version),
             cic->seed);
    }
}
